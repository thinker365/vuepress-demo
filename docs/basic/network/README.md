...
1. 根 DNS 服务器
	- 最顶级的 DNS 服务器，全世界有 400 多台根域名服务器，由 13 个不同的组织管理，根域名服务器提供 TLD 服务器的 IP 地址。

1. 顶级域 DNS 服务器
	- 这个我们比较熟悉，像是常见的顶级域（如 com、org、net、edu 和 gov）和所有的国家顶级域（uk、fr、ca 和 jp），TLD 服务器提供了权威 DNS 服务器的 IP 地址。

1. 权威 DNS 服务器
	- 这个服务器就是因特网上具有公共可访问主机的 DNS 记录的服务器。

1. 本地 DNS 服务器
	- 一般来说，每个 ISP 都有一台本地 DNS 服务器，本地 DNS 服务器会临近主机端。
...
参考：[https://mp.weixin.qq.com/s/6-0c8uYmjiluiLI2ZQjN3A](https://mp.weixin.qq.com/s/6-0c8uYmjiluiLI2ZQjN3A)